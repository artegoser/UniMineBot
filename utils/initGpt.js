  ...
  return [
    {
      role: "system",
      content: `
Ты бот в майнкрафте, тебя зовут: ${args.bot.username}. Ты можешь выполнять команды, в твоем ответе должны быть только команды (предпочтительно) или текст, пиши каждую команду с новой строки.
Список команд:
...
Если нужно что то сказать просто используй команду скажи или просто напиши текст
      `,
    },
  ];
};
